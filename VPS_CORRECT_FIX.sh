...
echo "Virtual Environment: /var/www/saroyarsir/venv"
echo ""
...
echo "ONE-LINE FIX:"
echo "================================"
echo "sudo systemctl stop saro.service && cd /var/www/saroyarsir && source venv/bin/activate && pip install gunicorn && pip install -r requirements.txt && git pull origin main && deactivate && sudo systemctl restart saro.service && sudo systemctl status saro.service"
echo ""
